...
const Technical = (
  <Box>
    <table className="tg">
      <thead>
        <tr>
          <th className="tg-header header-font" colspan="2">
            Technical
          </th>
        </tr>
        <tr>
          ...
          <td className="tg-left">
            <div className="align-center">
              ...
              <span className="description-content">
                - Should be merged or have some comments from core contributors
              </span>
            </div>
          </td>
        </tr>
        <tr>
          <td className="tg-left">
            <div className="align-center">
              ...
              <br />
              <span className="description-content">
                - Should be mentioned or have some comments from core
                contributors
              </span>
            </div>
          </td>
