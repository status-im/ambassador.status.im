          ...
          <td className="tg-left">
            <div className="align-center">
              <span className="description-header">
                Status public chats moderations
              </span>
              <br />
              <span className="description-content">
                - Answering questions or sharing news and updates on Status in
                public chats
              </span>
              <br />
              ...
              <span className="description-content">
                - e.g., moderating{" "}
                <a
                  href="https://join.status.im/status-korean"
                  target="_blank"
                ...
                &{" "}
                <a
                  href="https://join.status.im/movie"
                  target="_blank"
                  rel="noopener noreferrer"
                  className="table-link"
                >
        ...
        <tr>
          <td className="tg-left">
            <div className="align-center">
              ...
              <br />
              <span className="description-content">
                - New ambassadors should complete at least 2 tasks
              </span>
            </div>
          </td>
        </tr>
        <tr>
          <td className="tg-left">
            <div className="align-center">
              ...
              <br />
              <span className="description-content">
                - Additional bonus for participating in the referral program. Up
                to 10 referrals
              </span>
            </div>
          </td>
