        ...
        <div>
          <FirstRow>
            <div>
              <Container>
                <DivContainer>
                  <GetStarted>
                    Ready to get started with the Status Network?
                  </GetStarted>
                </DivContainer>
                <a
                ...
                >
                  <CtaButton>
                    Get Status{" "}
                    <KeyboardArrowRightIcon style={{ marginLeft: "30px" }} />
                  </CtaButton>
                </a>
              </Container>
            </div>
          ...
          <SecondRow>
                    ...
                    >
                      <g opacity="0.5">
                        ...
                        <path
                          fill-rule="evenodd"
                          clip-rule="evenodd"
                          d="M14.203 14.0701H16.552L16.905 11.4371H14.203V9.74713C14.203 8.98313 14.416 8.46213 15.552 8.46213H17V6.10013C16.2988 6.031 15.5946 5.99763 14.89 6.00013C12.8 6.00013 11.37 7.22513 11.37 9.48613V11.4361H9V14.0701H11.371V20.8571H14.203V14.0701Z"
                          fill="black"
                        />
                      </g>
                    </svg>
                  ...
                  >
                    ...
                    >
                      <g opacity="0.5">
                        <rect width="26" height="26" rx="2" fill="white" />
                        <path
                          d="M13.0679 5.14282C8.68929 5.14282 5 8.66068 5 13.0035C5 13.1428 5.00357 21.1428 5.00357 21.1428L13.0679 21.1357C17.45 21.1357 21 17.4821 21 13.1393C21 8.79639 17.45 5.14282 13.0679 5.14282ZM13 17.7143C12.3071 17.7143 11.6464 17.5607 11.0571 17.2821L8.16071 18L8.97857 15.3214C8.62857 14.675 8.42857 13.9321 8.42857 13.1428C8.42857 10.6178 10.475 8.57139 13 8.57139C15.525 8.57139 17.5714 10.6178 17.5714 13.1428C17.5714 15.6678 15.525 17.7143 13 17.7143Z"
                          fill="#090909"
                        />
                      </g>
                    </svg>
            ...
            <div style={{ display: "inline-block" }}>
              <a
                href="https://status.im/privacy-policy/"
                target="_blank"
                rel="noopener noreferrer"
              >
                {" "}
              ...
              <ul>
                <li style={{ color: "rgba(255, 255, 255, 0.6)", margin: "0" }}>
                  Status Research & Development GmbH, Baarerstrasse 10, Zug,
                  Switzerland
                </li>
              </ul>
            </div>
